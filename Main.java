...
public class Main {
    ...
    public static String option2ProductEntry() {
        ...
        String newProduct = productName + " | " + expiryDate + " | " + entryDate + " | " + manufacturer + " | " + unit + " | " + stock + " | " + comment;
    ...
    public static void main(String[] args) {
        ...
        if (userInput == 1) {
            ...
            try {
                BufferedWriter writer = new BufferedWriter(new FileWriter("New deliveries.txt"));
            ...
            if (answerOption2.equals("yes") || answerOption2.equals("Yes")) {
                while (answerOption2.equals("yes") || answerOption2.equals("Yes")==true) {
                    try {
                        BufferedWriter writer = new BufferedWriter(new FileWriter("New deliveries.txt"));
                        writer.write(option2ProductEntry());
                        writer.close();
                    ...
                    if (answerOption2.equals("no")==true || answerOption2.equals("No")==true) {
                        break;
                    }
                }
            }
